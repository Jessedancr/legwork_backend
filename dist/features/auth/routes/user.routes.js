...
const userIdValidator_1 = require("../../../core/middlewares/userIdValidator");
...
userRouter.patch("/:userId/update-user-details", authjwt_middleware_1.authMiddleware, (0, express_validator_1.checkSchema)(userIdValidator_1.userIdValidationSchema), user_controllers_1.updateUserDetails);
